...
{
    [Table("ProgressNote")]
    [Index(nameof(AnimalGid), Name = "IX_ProgressNote")]
    [Index(nameof(CustomerGid), Name = "IX_ProgressNote_1")]
    [Index(nameof(ParentOrgCode), Name = "IX_ProgressNote_2")]
    [Index(nameof(Vn), Name = "IX_ProgressNote_3")]
    public partial class ProgressNote
    {
        ...
        public byte? SedationScore { get; set; }
        [StringLength(255)]
        public string OtherSecretion { get; set; }
    }
}
